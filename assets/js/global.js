document.addEventListener('DOMContentLoaded', function () {
  ...
  const createMenuItem = (item) => {
    ...
    a.className = 'menu-item-hidden transition-all duration-300 bg-gray-900/80 backdrop-blur-md border border-gray-700/50 text-white font-medium text-sm rounded-lg block w-48 py-3 px-4 text-center';
    if (item.dataLang) {
